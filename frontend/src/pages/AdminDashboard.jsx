    ...
    <>
      <section className="admin-metric-grid">
        <div className="admin-card metric">
          <p className="metric value">CSAT %</p>
          <div className="metric-value">{Math.round(summary.csat_pct ?? 0)}%</div>
          <span className="metric-help">Overall satisfaction</span>
        </div>
        <div className="admin-card metric">
          <p className="metric value">Avg Rating</p>
          <div className="metric-value">{Number(summary.avg_rating ?? 0).toFixed(2)}</div>
          <span className="metric-help">5-point scale</span>
        </div>
        <div className="admin-card metric">
          <p className="metric value">Responses</p>
          <div className="metric-value">{summary.responses ?? 0}</div>
          <span className="metric-help">Collected in the window</span>
        </div>
        <div className="admin-card metric">
          <p className="metric value">Peak day</p>
